...
public class JcsServicingService implements com.example.demo.Service.Data.JcsServicingService {

    private JcsServicingRepository jcsServicingRepository;

    public JcsServicingService(JcsServicingRepository jcsServicingRepository) {
