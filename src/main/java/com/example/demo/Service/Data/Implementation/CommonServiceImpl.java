...
public class CommonServiceImpl<T, TId> implements com.example.demo.Service.Data.CommonService<T, TId> {

    private final CrudRepository<T, TId> repository;
    public CommonServiceImpl(CrudRepository<T, TId> repository) {
